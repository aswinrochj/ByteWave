...
const SignupContent = () => {
    ...
    const handleSignup = (e: React.FormEvent) => {
        e.preventDefault();
        setIsLoading(true);
        // Simulate Account Creation delay -> Redirect
        setTimeout(() => {
    ...
    return (
        ...
        >
            <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-white mb-2 capitalize">{role} Sign Up</h2>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="flex items-center text-sm text-slate-400">
                    <input type="checkbox" className="mr-2 rounded border-slate-700 bg-slate-800 text-teal-500 focus:ring-teal-500" required />
                    <span>I agree to the <a href="#" className="text-teal-400 hover:text-teal-300">Terms of Service</a></span>
                </div>
            ...
            <div className="mt-8 text-center">
                <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-xs uppercase"><span className="bg-slate-800 px-2 text-slate-500">Or sign up with</span></div>
                </div>
                ...
                <p className="mt-6 text-sm text-slate-400">
                    Already have an account? <Link href={`/login?role=${role}`} className="text-teal-400 hover:text-teal-300 font-medium">Log in</Link>
                </p>
            </div>
        </motion.div>
    );
